            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="answer.isCorrect.label" default="Is Correct" /></td>
                            
                            <td valign="top" class="value"><g:formatBoolean boolean="${answerInstance?.isCorrect}" /></td>
